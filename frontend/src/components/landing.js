...
const Landing = () => {
  return (
    <>
        ...
        <div class="container px-12 mx-auto flex flex-wrap flex-row md:flex-row items-center justify-between w-full">
          <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left px-3">
            ...
            <p class="leading-normal text-2xl">
              Enrich your knowledge and ignite your imagination.
            </p>
          ...
          <div class="w-full md:w-3/5 py-6 text-center flex justify-end align-middle">
            <img class="md:w-4/5 z-10 max-w-lg" src={hero} alt="hero" />
          </div>
        </div>
      </div>
      <div className="gradient relative -mt-12 lg:-mt-24">
        <svg
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 py-5 gap-5">
        <Card />
